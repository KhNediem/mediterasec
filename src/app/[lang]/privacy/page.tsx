...
export const metadata = {
  title: "Privacy Policy | MediteraSec",
  description: "Privacy Policy and Data Handling for MediteraSec.",
};
    ...
    <div className="bg-meditera-white min-h-screen py-24 px-6 lg:px-8">
      <div className="mx-auto max-w-3xl">
        ...
        <div className="prose prose-gray max-w-none text-gray-600">
          ...
          <p className="mb-4">
            If you have questions or comments about this policy, you may email us or use our <Link href="/contact" className="text-[var(--color-pulse-navy)] hover:underline">contact form</Link>.
          </p>
        </div>
      </div>
    </div>
